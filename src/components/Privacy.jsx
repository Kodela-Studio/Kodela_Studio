    ...
    <main className="bg-kodela-black px-6 pb-24 pt-36 text-kodela-cream sm:pt-40">
      ...
      <article className="mx-auto max-w-3xl">
        ...
        <div className="mt-12 space-y-10 border-t border-white/15 pt-10 text-sm leading-7 text-zinc-300">
          ...
          <section><h2 className="mb-3 text-xl font-normal text-kodela-cream">Dine rettigheter</h2><p>Du kan be om innsyn, retting eller sletting av personopplysninger vi har om deg, der regelverket gir rett til det. Kontakt oss på post@kodelastudio.no</p></section>
          ...
          <section><h2 className="mb-3 text-xl font-normal text-kodela-cream">Kontakt</h2><p>Kodela Studio<br/>Oslo, Norge<br/><a className="text-kodela-gold" href="mailto:post@kodelastudio.no">post@kodelastudio.no</a></p></section>
        </div>
      </article>
    </main>
  );
